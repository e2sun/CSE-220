...
int main() {
    ...
    QTNode *root2 = load_preorder_qt("tests/input/my_own_test.txt");
    // You will need to write your own code to verify that your quadtree was constructed properly
    delete_quadtree(root); 
    ...
    save_preorder_qt(root2,"tests/output/my_test_output.txt");
    ...
    image = load_image("images/building1.ppm"); 
    root = create_quadtree(image, 25);
    //QTNode *root_test = create_test_quadtree_TEST();
    //save_qtree_as_ppm(root_test, "tests/output/anothertest.txt");
